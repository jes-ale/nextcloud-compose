...
Contar con un sistema autohospedado que garantice soberanía, disponibilidad y seguridad ofrece extensas ventajas para profesionales, investigadores, estudiantes y académicos. Este artículo presenta una solución técnica para la gestión y sincronización de notas, trabajos de investigación y documentos académicos, utilizando tecnologías de código abierto: **Nextcloud**, **Joplin**/**Obsidian** para servir **Markdown**, implementadas sobre un servidor VPS con **Docker** y **Nginx** como reverse proxy.
